...
static class MenuController
{
    ...
    private static const int MENU_TOP = 575;
    private static const int MENU_LEFT = 30;
    private static const int MENU_GAP = 0;
    private static const int BUTTON_WIDTH = 75;
    private static const int BUTTON_HEIGHT = 15;
    private static const int BUTTON_SEP = BUTTON_WIDTH + MENU_GAP;
    private static const int TEXT_OFFSET = 0;

    private static const int MAIN_MENU = 0;
    private static const int GAME_MENU = 1;
    private static const int SETUP_MENU = 2;

    private static const int MAIN_MENU_PLAY_BUTTON = 0;
    private static const int MAIN_MENU_SETUP_BUTTON = 1;
    private static const int MAIN_MENU_TOP_SCORES_BUTTON = 2;
    private static const int MAIN_MENU_QUIT_BUTTON = 3;

    private static const int SETUP_MENU_EASY_BUTTON = 0;
    private static const int SETUP_MENU_MEDIUM_BUTTON = 1;
    private static const int SETUP_MENU_HARD_BUTTON = 2;
    private static const int SETUP_MENU_EXIT_BUTTON = 3;

    private static const int GAME_MENU_RETURN_BUTTON = 0;
    private static const int GAME_MENU_SURRENDER_BUTTON = 1;
    private static const int GAME_MENU_QUIT_BUTTON = 2;
